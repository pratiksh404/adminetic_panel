...
@section('content')
    <x-admin.index-page name="setting" route="setting">
        <x-slot name="content">
            {{-- ================================Card================================ --}}
            ...
            <div class="tab-content" id="pills-icontabContent">
                <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel"
                    ...
                    @include('admin.layouts.modules.setting.tabs.setting_value')
                </div>
                <div class="tab-pane fade" id="pills-iconprofile" role="tabpanel" aria-labelledby="pills-iconprofile-tab">
                    @include('admin.layouts.modules.setting.tabs.setting_list')
                </div>
            </div>
            {{-- =================================================================== --}}
        </x-slot>
