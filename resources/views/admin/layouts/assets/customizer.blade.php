<script>
    ...
    var customizer = '<div class="customizer-links">' +
        ...
        '                                    src="{{ asset('assets/images/landing/layout-images/dubai.jpg') }}"' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/los.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Los Angeles</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/paris.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Paris</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/tokyo.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Tokyo</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/moscow.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Moscow</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/singapore.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Singapore</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/newyork.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>New York</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/barc.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Barcelona</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/madrid.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Madrid</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/romo.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Rome</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/seoul.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>Seoul</h6>' +
        '                        </div>' +
        '                    </li>' +
        ...
        '                        <div class="layout-img"> <a href="javascript:void(0)"><img' +
        '                                    src="{{ asset('assets/images/landing/layout-images/london.jpg') }}"' +
        '                                    class="img-fluid" alt="" /></a>' +
        '                            <h6>London</h6>' +
        '                        </div>' +
        '                    </li>' +
